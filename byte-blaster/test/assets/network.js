...
window.netReportEnemyHit = function(id, dmg, stomp, elem){
  if(!window.netActive || isHost) return;
  wsSend({type:'game_event', event:'hit_enemy', data:{id:id, dmg:dmg||1, stomp:!!stomp, elem:elem||null}});
};
    ...
    window.hurtE = function(e, dmg, stomped){
      if(window.netActive && !isHost){
        if(e && e.id!=null){
          ...
          window.netReportEnemyHit(e.id, dmg, stomped, e._netHitElem||null);
        }
