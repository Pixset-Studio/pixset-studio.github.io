  ...
  const VERSIONS = [
    {
      ...
      add: [
        ...
        ['wn103a21', 'Геймпады: играй на джойстике, а вдвоём на одном компьютере — с двумя. Прыжок, выстрел и пауза меняются в настройках'],
      ],
      chg: [
        ...
        ['wn103c12', 'Пролог открывается первым, а первый мир — только после его прохождения'],
        ['wn103c13', 'Спокойный режим стал ещё мягче: пилы, шары на верёвках, гейзеры, сосульки, токсины и молнии сносят одну стадию робота, а не отнимают жизнь сразу'],
        ['wn103c14', 'Шрифт игры дополнен знаками почти всех языков — арабского, иврита, тайского, китайского, японского, корейского и других — и больше не грузится из интернета'],
        ['wn103c15', 'Полосы прокрутки теперь в стиле игры, а не белые системные'],
      ],
      fix: [
        ...
        ['wn103f19', 'После возрождения на чекпоинте убитые враги и собранные монеты позади него больше не появляются снова'],
        ['wn103f20', 'Музыка главного меню включается сразу, как только звук разрешён (в приложении — с первой секунды), а если выключить и снова включить звук в меню — возвращается'],
      ],
    },
    {
      v: '1.0.2',
